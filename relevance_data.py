...
narrative_map = {
    "How has the use of wearable technology improved athlete performance?":
        "The user is seeking information on how wearable technology has positively impacted the performance of athletes, looking for examples and benefits.",

    "What are the characteristics that define a particular music genre?":
        "The user is interested in understanding the defining characteristics that distinguish one music genre from another, possibly for music appreciation or analysis.",

    "How can AI assist in analyzing large datasets in scientific research?":
        "The user wants to know how artificial intelligence is utilized to analyze extensive datasets in scientific research, aiming to grasp the practical applications and advantages of AI in this context.",

    "What are the potential benefits and risks of genetically modified organisms (GMOs) in food?":
        "The user is looking for a balanced overview of the advantages and disadvantages associated with GMOs in food, possibly to make informed decisions or engage in discussions about food safety.",

    "What are the most promising renewable energy sources for a sustainable future?":
        "The user is interested in learning about the renewable energy sources that hold the most promise for creating a sustainable and environmentally friendly future.",

    "How can virtual reality enhance immersive learning experiences for students?":
        "The user is curious about how virtual reality technology can be leveraged to improve the educational experience, possibly for educational planning or understanding the potential of VR in education.",

    "Can social media platforms be effective tools for organizing and mobilizing social movements?":
        "The user is exploring the effectiveness of social media platforms in the context of social activism and is likely interested in their role in social and political change.",

    "What ethical considerations arise from the use of emerging medical technologies?":
        "The user is concerned with ethical issues surrounding the adoption of new medical technologies and seeks an understanding of the ethical dilemmas that may arise.",

    "Have we found any promising candidates for hosting extraterrestrial life?":
        "The user is inquiring about recent discoveries or developments regarding celestial bodies that may potentially support extraterrestrial life.",

    "What conservation efforts are being made to protect biodiversity in the face of climate change?":
        "The user wants to know about ongoing conservation initiatives aimed at safeguarding biodiversity in the context of climate change, suggesting an interest in environmental conservation efforts."
}
...
g_questions_map[2] = {
    "What are the characteristics that define a particular music genre?": {
        ...
        3: [
            ...
            "How do music melody reflect the values and identity of different communities?"   # Irrelevant (0)
        ]
    }
}
...
g_questions_map[3] = {
    "How can AI assist in analyzing large datasets in scientific research?": {
        1: [
            ...
            "What are the potential benefits of using VR for data analysis in scientific studies?", # Irrelevant (0)
        ...
        2: [
            ...
            "What are some notable examples of AI-driven breakthroughs in coding?", # Irrelevant (0)
        ...
        3: [
            ...
            "How can excel enhance data visualization and representation for research purposes?", # Irrelevant (0)
...
g_questions_map[4] = {
    "What are the potential benefits and risks of genetically modified organisms (GMOs) in food?": {
        1: [
            ...
            "Can you explain how GTOs may impact biodiversity and ecosystems?", # Irrelevant (0)
        ...
        2: [
            ...
            "Can you discuss the public perception and controversies surrounding new energy?", # Irrelevant (0)
        ...
        3: [
            ...
            "What is the future outlook for GMOs in terms of their role in fire electricity and instrument production?" # Irrelevant (0)
        ]
    }
}
...
g_questions_map[5] = {
    "What are the most promising renewable energy sources for a sustainable future?": {
        1: [
            ...
            "Can you explain the concept of energy efficiency in technologies?", # Irrelevant (0)
        ...
        2: [
            ...
            "What are the color transitioning to new energy form?", # Irrelevant (0)
        ...
        3: [
            ...
            "What is the outlook for electricity as a primary source of power in the coming decades?", # Irrelevant (0)
